...
# function for properly reading data from dataset
...
#function for properly saving data into a dataset
...
# Extraction of stock names from headers
...
# Adding new fields for indicators
...
# Saving the results to a CSV file to later plot from
