...
def extract_moneysupply():
     if os.path.exists('./scraping/data/MoneySupply/MoneySupply.csv'):
        os.remove('./scraping/data/MoneySupply/MoneySupply.csv')
     file = pandas.read_csv('./scraping/data/MoneySupply/FRB_H6.csv')
     ...
     print(df)
     df.to_csv('./scraping/data/MoneySupply/MoneySupply.csv')