...
def extract_interestratesbonds():
    if os.path.exists('./dataset/data/InterestRatesBonds/InterestRatesBonds.csv'):
        os.remove('./dataset/data/InterestRatesBonds/InterestRatesBonds.csv')
    rates_old = pandas.read_csv('./dataset/data/InterestRatesBonds/yield-curve-rates-1990-2021.csv')
    rates_2022 = pandas.read_csv('./dataset/data/InterestRatesBonds/daily-treasury-rates_2022.csv')
    rates_2023 = pandas.read_csv('./dataset/data/InterestRatesBonds/daily-treasury-rates_2023.csv')
    ...
    df.to_csv('./dataset/data/InterestRatesBonds/InterestRatesBonds.csv')